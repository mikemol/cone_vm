...
- `tests/test_scheduler_commutation.py::test_scheduler_commutation_small_suite[(add (suc (suc zero)) (mul (suc zero) zero))]` - m3: mul arena commutation not guaranteed yet.
